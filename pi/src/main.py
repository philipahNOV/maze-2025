...
class MainApp(tk.Tk):
    def __init__(self, mqtt_client):
        ...
        self.frames = {}
        for F in (BootScreen1, Screen1, Tuning, ControlScreen, BootScreen, NavigationScreen, InfoScreen, LocatingScreen, MainScreen, AutoPathScreen, CustomPathScreen, ControllingScreen):
