...
class Screen2(tk.Frame):
    ...
    def create_widgets(self):
        ...
        # Create a button on the right side, vertically centered
        self.goto_screen3_button = tk.Button(self, text="Use AI", command=lambda: self.screen_ai("2.3"))
        self.goto_screen3_button.grid(row=1, column=1, rowspan=5, sticky="nsew", padx=(10, 100), pady=(10, 10))
        print(f"Button created: {self.goto_screen3_button}")  # Debug statement

        self.goto_screen3_button = tk.Button(self, text="Use math", command=lambda: self.screen_math("1.3"))
        self.goto_screen3_button.grid(row=2, column=1, rowspan=5, sticky="nsew", padx=(10, 100), pady=(10, 10))
        print(f"Button created: {self.goto_screen3_button}")  # Debug statement
