...
class Controller:
    ...
    def __init__(self, arduinoThread: arduino_connection.ArduinoConnection, tracker: tracking.BallTracker):
        ...
        #ARDUINO PARAMETERS
        self.x_offset = -0.0055 # Offset for x-axis orientation (BEST SO FAR: -0.01)
    ...
    def posControl(self, ref):
        ...
        if abs(edot_x) > 20 or abs(e_x) > 1000: self.e_x_int = 0
        if abs(edot_y) > 20 or abs(e_y) > 1000: self.e_y_int = 0
